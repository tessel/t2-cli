        ...
        remoteProcess.once('close', function() {
          ...
          return self.simpleExec(commands.reconnectWifi())
            .then(function() {
              ...
              return self.connection.exec(commands.ubusListen())
                .then(function(remoteProcess) {
                  var result = {};
...
// How long Tessel will wait for a status after attempting to connect
// Exposed for easier testing
Tessel._wifiConnectionTimeout = 10000;
