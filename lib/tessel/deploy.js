...
actions.tarBundle = function(opts) {
  ...
  // Convert `deployLists.ignores` into ignoreRules
  deployLists.ignores.forEach(ignore => ignoreRules.push(`node_modules/**/${ignore}`));
...
actions.writeToFile = function(t, entryPoint) {
  return new Promise(function(resolve, reject) {
    ...
    var shellScriptPath = path.posix.join(Tessel.REMOTE_PUSH_PATH, PUSH_START_SCRIPT_NAME);
