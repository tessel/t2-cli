...
module.exports.terminateConnections = function () {
  return Promise.map(usbCollection, function (usb) {
    return Promise.promisify(usb._close.bind(usb))();
  })
}
