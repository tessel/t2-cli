                  ...
                  return Menu.prompt({
                    ...
                    prompt: {
                      ...
                      choices: tessels.map((tessel, i) => {
                        ...
                        const display = `\t${tessel.connection.connectionType}\t${colors.magenta(tessel.name)}\t${authorization}`;
            ...
            return tessel.fetchCurrentBuildInfo()
              ...
              .catch(error => {
                ...
                if (error.message.includes('No such file or directory')) {
                  log.warn(`Could not find firmware version on ${colors.magenta(tessel.name)}`);
