...
function provisionTessel(opts) {
  ...
  return getTessel(opts).then(function(tessel) {
...
function printAvailableNetworks(opts) {
  // Grab the preferred Tessel
  return getTessel(opts).then(function(selectedTessel) {
    // Run the script on Tessel
    return selectedTessel.findAvailableNetworks().then(function(networks) {
