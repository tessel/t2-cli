    ...
    if (opts.list) {
      ...
      var shaPromise = tesselPromise.then(function(tessel) {
          ...
          .then(function(currentSHA) {
            // Figure out the human readable version
       ...
       // If the update is forced or this build was requested
        if (opts.build) {
          ...
          // If they requested a specific version
            ...
            verifiedVersion = updates.fetchSHAForBuildVersion(requested)
            .then(function(sha) {
              return requested;
            })
            .catch(reject);
            ...
            verifiedVersion.then(function(requestedVersion) {
              ...
              if (!opts.force && currentVersion >= requestedVersion) {
                ...
                .then(function startUpdate(build) {
                  ...
                  .then(logCompletion.bind(this, tessel.name, currentVersion, requestedVersion), reject)
                  .then(function() {
