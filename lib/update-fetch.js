...
// TEMP
var buildsListURL = 'https://s3.amazonaws.com/builds.tessel.io/t2/firmware/builds.json';
/*
...
function fetchBuild(version) {
  return new Promise(function(resolve, reject) {
    logs.info("Beginning update download...");
    ...
    .then(function startDownload(sha) {
      ...
      var req = request.get('https://s3.amazonaws.com/builds.tessel.io/t2/firmware/9a85c84f5a03c715908921baaaa9e7397985bc7f.tar.gz')
